...
void NormalizerC::init(Normalizer::norm_t norm_type, int dim)
{
...
void NormalizerC::normalize(float * data, int window_count, bool use_last_stats)
{
	if (!use_last_stats)
	{
		switch (m_norm_type)
